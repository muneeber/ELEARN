        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{ __("You're logged in as Creator!") }}
                </div>
            </div>
        </div>
    </div> --}}
                        ...
                        <div class="container px-5 py-11 mx-auto">
                            <div class="flex flex-wrap -m-4">
                                <div class="p-4 md:w-1/3">
                                    ...
                                    <a href="{{ route('addcourse') }}" class="p-4 hover:bg-slate-800 hover:text-gray-500   md:w-1/3">
                                        <div
                                            class="h-full border-2 flex justify-center items-center flex-col  border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="216" height="216"
                                                style="fill:#9cb1d0" class="bi bi-plus" viewBox="0 0 16 16">
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                                            </svg>
                                            <div class="p-6 text-center">
                                                <h2
                                                    class="tracking-widest text-xs title-font font-medium text-gray-400 uppercase mb-1">
                                                    New Course</h2>
                                                <h1
